  ...
  return (
    <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 lg:justify-between">
      {redes.map(({ id, img, name, url, color }) => (
        <a href={url} key={id} target="_blank" rel="noopener noreferrer" className={`flex flex-col lg:flex-row gap-2 items-center justify-center py-4 border border-[${color}] rounded-3xl`}>
